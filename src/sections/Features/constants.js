...
export const FEATURES = [
  ...
  },
  {
    color: "purple.main",
    title: "Animations",
    heading: "More attractive websites with cool micro-animations",
  ...
  },
  {
    ...
    title: "Load time",
    heading: "Extra fast load-time so that your users don’t have to wait",
    desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua",
    anim: <Rocket />,
  },
  {
    color: "red.main",
    title: "Compatibility",
    heading: "Desktop, Tablets or Mobile: Looks great on any kind of device",
    desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua",
    anim: <Responsivity />,
  },
];
