export const TESTIMONIALS = [
  {
    image: "/media/images/avatars/01.png",
    name: "Guy Hawkins",
  ...
  {
    image: "/media/images/avatars/02.png",
    name: "Devon Lane",
    occupation: "Web Designer",
    title: "Looking forward to another project",
    review: `Crio unall lelstenpquee ignmisdsi mine tis mtae ivaenenst raun usurcs egte cnnu crsequeslei vvriera masriu ni alaiqmu sem farlliing ut rombi cnttiunid geauu inruetdm ivlet ouesidm ni eeneqellutsp aassm tcaalrep iusd ceirtlusi lacus des tuprsi tiincndtu di uitqlae risus eftguai ni aent umest ditmcu ta eortmp ommodoc ouamplrlrce a calsu telmbvsuiu des ucra non idoo iesmuod laancii ta siuq rissu sed atvtuupel oido tu nemi nidblat tpaulotv mnsaeaec tvoplaut natildb qaaluim aetim erta etilv lseeecurisq ni dictum non sncurteotec a reat mna at tscelu aunr isud liconvasl lalinoscv`,
  ...
  {
    image: "/media/images/avatars/04.png",
    name: "Courtney Henry",
  ...
  {
    image: "/media/images/avatars/06.png",
    name: "Ralph Edwards",
